        ...
        <div className="APCcontent">
            ...
            <div className="indicatorContent">
                <div className="contentItem">
                    ...
                    <span className="APCitem">电损耗1</span>
                    <span className="APCNumber">11</span>
                </div>
                <div className="contentItem">
                    <i className="biaoji"></i>
                    <span className="APCitem">电损耗2</span>
                    <span className="APCNumber">20</span>
                </div>
                <div className="contentItem">
                    <i className="biaoji"></i>
                    <span className="APCitem">电损耗3</span>
                    <span className="APCNumber">77</span>
                </div>
            </div>
        </div>
    )
