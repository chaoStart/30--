    ...
    return (
        <div id="mainbox">
            ...
            <div className="bottomApp">
                <div className="appitem">
                    {/* <div className="img"></div> */}
                    <img src={img5} alt="1" onClick={() => { window.open('https://www.baidu.com/?tn=40020637_27_oem_dg', "target", ""); }} />
                    <div className="apptitle">
                        装置收率模型
                    </div>
                </div>
                ...
                <div className="appitem">
                    {/* <div className="img"></div> */}
                    <img src={img8} alt="1" onClick={() => { window.open('https://www.baidu.com/?tn=40020637_27_oem_dg', "target", ""); }} />
                    <div className="apptitle">
                        能效指标管理
                    </div>
                </div>
